...
(define-constant agent-0 'STNHKEPYEPJ8ET55ZZ0M5A34J0R3N5FM2CMMMAZ6)
...
(begin        
	...
	(begin
	(unwrap-panic (begin
		(unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.nft-a transfer u1 tx-sender agent-1)))
	...
	(begin
		(unwrap-panic (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.nft-b transfer u1 tx-sender agent-2)))
...
(begin
	...
	(unwrap-panic (begin
		...
		(asserts! (is-ok (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.nft-a transfer u1 tx-sender (as-contract tx-sender))) cannot-escrow-nft )
